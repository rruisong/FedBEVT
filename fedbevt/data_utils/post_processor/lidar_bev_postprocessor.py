...
from fedbevt.utils.transformation_utils import dist_to_continuous
from fedbevt.data_utils.post_processor.base_postprocessor \
    import BasePostprocessor
from fedbevt.utils import box_utils
from fedbevt.visualization import vis_utils
...
class LidarBevPostprocessor(BasePostprocessor):
    ...
    def visualize(pred_box_tensor, gt_tensor, pcd, show_vis, save_path, dataset = None):
        ...
        save_path : str
            Save the visualization results_old to given path.
