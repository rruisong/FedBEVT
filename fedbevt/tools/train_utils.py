...
from fedbevt.tools.multi_gpu_utils import get_dist_info
from fedbevt.utils.common_utils import torch_tensor_to_numpy
...
def create_model(hypes):
    ...
    model_filename = "fedbevt.models." + backbone_name
...
def setup_lr_schedular(hypes, optimizer, n_iter_per_epoch):
    ...
    if lr_schedule_config['core_method'] == 'step':
        ...
        print(lr_schedule_config['num_rounds'])
        num_steps = lr_schedule_config['epoches'] * n_iter_per_epoch * lr_schedule_config['num_rounds'] # added num of comm. rounds
...
def save_bev_seg_binary(output_dict,
                        ...
                        test=False):
    """
    Save the bev segmetation results_old during training.
